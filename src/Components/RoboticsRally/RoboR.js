    ...
    <div>
      ...
      <div className="bdy">
        <div className="heading">
          <h1 className="heading1">ROBO RALLY</h1>
        </div>
        <div className="hBody">
         <b>Hello Guys!!!!</b><br/>
...
<br/>As you guys know rally is an event where the speed is the key for winning so we put bots with high speed that makes you experience the thrust of the actual road rallying.<br/>
