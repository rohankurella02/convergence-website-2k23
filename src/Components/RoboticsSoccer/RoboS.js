    ...
    <div>
      ...
      <div className="bdy">
        <div className="heading">
          <h1 className="heading1">ROBO SOCCER</h1>
        </div>
        <div className="hBody">
          <b>Hello Guys!!!!</b>
          <br />
          Convergence 2k23 is back with many exciting events!!!!
          <br />
          As part of Convergence 2k23, We robotics are hosting the event.
          <br />
          <br />
          <b>ROBO SOCCER</b>
          <br />
          <br />
          As you know soccer is a game where it thrills each and every second.
          Playing soccer with bots with make your experience even more exciting.
          <br />
          <br />
          Here You can showcase your talent and win some exciting cash prizes.
          <br />
          <br />
          <b>1st - Rs-5000/-</b>
          <br />
